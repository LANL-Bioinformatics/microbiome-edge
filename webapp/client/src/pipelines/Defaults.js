export const intro = {
    title: 'Introduction',
    name: 'Microbiome EDGE Introduction/Quick Start',
    bgcolor: '#4F3C80'
}
...
export const workflowlist = {
    ...
    ReadsQC: {
        ...
        bulk_submission_template: '/docs/bulk-submissions/Microbiome-EDGE-Metagenomics-ReadsQC-bulk-submission.xlsx',
    },
    ReadbasedAnalysis: {
    ...
    'Metagenome Pipeline': {
        ...
        bulk_file_tip: 'Required',
        bulk_submission_template: '/docs/bulk-submissions/Microbiome-EDGE-Metagenomics-pipeline-bulk-submission.xlsx',
