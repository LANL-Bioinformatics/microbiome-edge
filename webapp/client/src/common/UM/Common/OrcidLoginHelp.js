      ...
      <Card color="light" outline className='shadow p-3 mb-5 bg-white rounded'>
        <CardBody>
          ...
          <CardText className='nmdc-header-orcid-login-help-text'>
            <p>
              Microbiome EDGE requires an ORCID iD to log in. When logged in you have access to features such as uploading
            ...
            <p>
              ...
              already have one, to sign into your ORCID account, then grant permission for Microbiome EDGE to access your
              ...
              ORCID record with your Microbiome EDGE workflow runs.
            </p>
